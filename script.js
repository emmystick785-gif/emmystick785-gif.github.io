...
.btn-primary:hover {
    ...
    box-shadow: 0 10px 35px #a78bfa25;
}
...
.preview-one {
    background: linear-gradient(135deg, #17151d, #29203e);
}

.preview-two {
    background: linear-gradient(135deg, #101c25, #1a2b3d);
}

.preview-three {
    background: linear-gradient(135deg, #241628, #3b214c);
}
